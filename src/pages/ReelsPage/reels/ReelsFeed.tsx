...
export function ReelsFeed() {
  ...
  return (
    <div className="flex h-[calc(100dvh-4rem-4.5rem-env(safe-area-inset-bottom))] w-full justify-center bg-black sm:h-[calc(100dvh-4.5rem-4.5rem-env(safe-area-inset-bottom))] lg:h-[calc(100dvh-4.5rem)]">
