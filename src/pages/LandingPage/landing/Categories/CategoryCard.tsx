...
export function CategoryCard({ title, description, image, icon: Icon, alt }: CategoryCardProps) {
  return (
    <Link
      to="/categories"
      className="group flex w-full flex-col overflow-hidden rounded-[20px] bg-white shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-card-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/40 focus-visible:ring-offset-2"
    >
