    ...
    <div className="relative min-h-screen overflow-hidden bg-[#F8F9FB]">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 py-5 sm:px-8">
        ...
        <button
              ...
              title="Coming soon"
              aria-disabled="true"
              className="flex items-center gap-1.5 rounded-full border border-[#EEF0F4] bg-white px-3 py-1.5 text-xs font-medium text-[#636E72] opacity-50"
            >
      ...
      <main className="relative z-10 flex min-h-[calc(100vh-80px)] items-center justify-center px-4 pb-16">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            {error && (
              <p id="gallery-password-error" className="text-sm text-red-500" role="alert">
                {error}
              </p>
            )}
