        ...
        >
          ...
          <div className="relative px-4 pb-5 pt-0 sm:px-6 sm:pb-6 lg:px-8">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="flex w-full flex-col gap-2.5 sm:flex-row sm:flex-wrap lg:pb-1">
                <button
                  type="button"
                  onClick={handleMessage}
                  className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-[#E5E7EB] bg-white px-5 text-sm font-semibold text-[#374151] transition-colors hover:bg-[#F9FAFB] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B46FE]/40 sm:w-auto"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] px-5 text-sm font-bold text-white shadow-[0_4px_14px_-2px_rgba(37,211,102,0.35)] transition-colors hover:bg-[#1EBE57] sm:w-auto"
                >
                ...
                <button
                  type="button"
                  onClick={handleBook}
                  className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#6B46FE] px-5 text-sm font-bold text-white shadow-[0_4px_14px_-2px_rgba(107,70,254,0.4)] transition-colors hover:bg-[#5A38E8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B46FE]/40 sm:w-auto"
                >
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px] xl:grid-cols-[minmax(0,1fr)_340px]">
          ...
          <div className="min-w-0 space-y-6">
            ...
            <section className="rounded-2xl border border-[#EEF0F4] bg-white p-5 sm:p-6">
              ...
              <div className="mt-4 flex gap-2 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" role="tablist" aria-label="Portfolio categories">
                {portfolioTabs.map((tab) => (
                  <button
                    ...
                    className={cn(
                      'shrink-0 rounded-full px-4 py-2 text-[13px] font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B46FE]/40',
                      activeTab === tab
