      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            'focus-visible:border-auth-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-auth-primary/15',
            'disabled:cursor-not-allowed disabled:bg-gray-50 disabled:opacity-60',
            leftIcon && 'pl-11',
            rightElement && 'pr-12',
            error && 'border-red-400 focus-visible:border-red-400 focus-visible:ring-red-400/15',
            className,
          )}
          aria-invalid={!!error}
